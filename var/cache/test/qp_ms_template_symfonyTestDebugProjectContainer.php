...
/**
 * qp_ms_template_symfonyTestDebugProjectContainer.
 *
...
class qp_ms_template_symfonyTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' => 'get13b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service',
            '2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' => 'get23b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service',
        ...
        $this->privates = array(
            '1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' => true,
            '2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' => true,
    ...
    /**
     * Gets the 'api.controllers.v1.default' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Controller\v1\DefaultController A Awin\ReportTask\Bundle\ReportBundle\Controller\v1\DefaultController instance
     */
    protected function getApi_Controllers_V1_DefaultService()
    {
        return $this->services['api.controllers.v1.default'] = new \Awin\ReportTask\Bundle\ReportBundle\Controller\v1\DefaultController();
    }

    /**
     * Gets the 'api.controllers.v1.phone_number' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Controller\v1\PhoneNumberController A Awin\ReportTask\Bundle\ReportBundle\Controller\v1\PhoneNumberController instance
     */
    protected function getApi_Controllers_V1_PhoneNumberService()
    {
        return $this->services['api.controllers.v1.phone_number'] = new \Awin\ReportTask\Bundle\ReportBundle\Controller\v1\PhoneNumberController();
    }

    /**
     * Gets the 'app.currency_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Service\CurrencyService A Awin\ReportTask\Bundle\ReportBundle\Service\CurrencyService instance
     */
    protected function getApp_CurrencyServiceService()
    {
        return $this->services['app.currency_service'] = new \Awin\ReportTask\Bundle\ReportBundle\Service\CurrencyService();
    }

    /**
     * Gets the 'app.merchant_transaction_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Service\MerchantTransactionService A Awin\ReportTask\Bundle\ReportBundle\Service\MerchantTransactionService instance
     */
    protected function getApp_MerchantTransactionServiceService()
    {
        return $this->services['app.merchant_transaction_service'] = new \Awin\ReportTask\Bundle\ReportBundle\Service\MerchantTransactionService();
    }

    /**
     * Gets the 'app.report_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Service\ReportService A Awin\ReportTask\Bundle\ReportBundle\Service\ReportService instance
     */
    protected function getApp_ReportServiceService()
    {
        return $this->services['app.report_service'] = new \Awin\ReportTask\Bundle\ReportBundle\Service\ReportService();
    }

    /**
     * Gets the 'app.storage_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Awin\ReportTask\Bundle\ReportBundle\Service\Storage\StorageCsvService A Awin\ReportTask\Bundle\ReportBundle\Service\Storage\StorageCsvService instance
     */
    protected function getApp_StorageServiceService()
    {
        return $this->services['app.storage_service'] = new \Awin\ReportTask\Bundle\ReportBundle\Service\Storage\StorageCsvService();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('O8DDtegCY3', 0, (__DIR__.'/pools'));
    ...
    protected function getCacheWarmerService()
    {
        ...
        })), $c, array()), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array()))));
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8']) ? $this->services['1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8'] : $this->get13b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8']) ? $this->services['2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8'] : $this->get23b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json', 1 => 'jsonp'), 'fallback_format' => 'json', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Awin\\ReportTask\\Bundle\\ReportBundle' => ($this->targetDirs[3].'/src/Bundle/ReportBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer')));
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.syslog_handler']) ? $this->services['monolog.handler.syslog_handler'] : $this->get('monolog.handler.syslog_handler')) && false ?: '_'});
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.file_log']) ? $this->services['monolog.handler.file_log'] : $this->get('monolog.handler.file_log')) && false ?: '_'});
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/' => array()), array('allow_origin' => true, 'allow_credentials' => false, 'allow_headers' => true, 'expose_headers' => array(), 'allow_methods' => array(0 => 'GET', 1 => 'POST', 2 => 'PUT', 3 => 'PATCH', 4 => 'DELETE', 5 => 'OPTIONS'), 'max_age' => 3600, 'hosts' => array(), 'origin_regex' => false, 'forced_allow_origin_value' => NULL));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $e->addLoader(new \Symfony\Component\Config\Loader\GlobFileLoader($b));
        ...
        $e->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($b, $d, false, array('jsonp' => false, 'json' => false, 'html' => true), 'json'));
        $e->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($b, $d, false, array('jsonp' => false, 'json' => false, 'html' => true), 'json'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a2c9092644ec312dfd95faf4b4528c3c8b3e3f9a34695a3346cc14552290fc7a');
    }
    ...
    /**
     * Gets the '1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get13b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service()
    {
        return $this->services['1_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get23b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8Service()
    {
        return $this->services['2_3b1c607720900b13641a593bdf871999b3fdccb8b02b2a5e338907591d55ebc8'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uIkershITz', 0, 'mv49Ngb3+zV45Nkd9Acpz0', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LZd-mPDhEw', 0, 'mv49Ngb3+zV45Nkd9Acpz0', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ReportBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Bundle/ReportBundle'),
            ...
            case 'router.resource': $value = ($this->targetDirs[3].'/app/config/routing/routing.yml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ReportBundle' => 'Awin\\ReportTask\\Bundle\\ReportBundle\\ReportBundle',
